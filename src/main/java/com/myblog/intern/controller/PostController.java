...
public class PostController {
    ...
    * */
    ...
    public List<CompletePost> getPost(){
        ...
        try{
                ...
                for(int i=0;i<posts.size();i++){
                    ...
                    if(posts.get(i).getActive()==0) return null;
                    List<Integer> selectedTopic= selectedTopicService.getSelectedTopicByPostId(posts.get(i).getId());
                    List<Comment> commentList= commentService.getCommentByPostId(posts.get(i).getId());
                    completePost=new CompletePost(posts.get(i).getId(),posts.get(i).getUserId(),posts.get(i).getDate(),posts.get(i).getTitle(),posts.get(i).getShortDescription(),posts.get(i).getDetails(),posts.get(i).getActive(),posts.get(i).getUpdatedAt(),posts.get(i).getView(),posts.get(i).getLikes(),posts.get(i).getComments(),selectedTopic,commentList);
